...
def resolve_session_metadata(
    ...
    *,
    ...
    namespace = (
        namespace_override if namespace_override is not None else payload.get("namespace")
    )
    user_id = user_id_override if user_id_override is not None else payload.get("user_id")
